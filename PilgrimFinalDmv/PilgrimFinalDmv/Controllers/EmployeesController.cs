...
namespace PilgrimFinalDmv.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(pilgrimfinalContext context, JwtAuthenticationManager jwtAuthenticationManager)
        {
            _context = context;
        ...
        public async Task<ActionResult<Employee>> PostEmployee(Employee employee)
        {
          if (_context.Employees == null)
          {
              return Problem("Entity set 'pilgrimfinalContext.Employees'  is null.");
          }
