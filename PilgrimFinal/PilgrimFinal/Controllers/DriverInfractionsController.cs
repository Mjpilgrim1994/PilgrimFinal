...
using PilgrimFinal.Data;
using PilgrimFinal.Models;

namespace PilgrimFinal.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DriverInfractionsController : ControllerBase
    {
        private readonly pilgrim_dmvContext _context;

        public DriverInfractionsController(pilgrim_dmvContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<DriverInfraction>> PostDriverInfraction(DriverInfraction driverInfraction)
        {
          if (_context.DriverInfractions == null)
          {
              return Problem("Entity set 'pilgrim_dmvContext.DriverInfractions'  is null.");
          }
